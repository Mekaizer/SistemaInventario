...
$muestra = mysqli_fetch_array($query);
$area=$_POST["area"];
$inventario ="SELECT * FROM inventario WHERE CodProducto='$Codigo' AND Area='$area'";
...
if($muestra!=NULL){
    ...
    if($cantidad==0 AND $muestra2!=Null){ 
    ...
    if($muestra2!=null){
        ...
        echo "<center>No se encontro el producto en la base de datos del Area";
    }
}
