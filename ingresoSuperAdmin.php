...
$tipo= $_SESSION['Tipo'];
$area=$_SESSION['Area'];
echo "<center><h2>Bienvenido $user usted es Administrador de todas las Areas</h2>";
...
<h2>Ingresar Nueva Persona</h2>
    ...
    <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-md-6">
                    <label class="control-label" for="Rut">Area del Usuario</label>
                    <input name="SArea" class="form-control"  type="text" required>
                  </div>
                </div>
            ...
            <input type="hidden" name="Responsable" value="<?= isset($_SESSION['Rut'])?htmlspecialchars($_SESSION['Rut']):'' ?>"/>
                <input type="hidden" name="Area" value="<?= isset($area)?htmlspecialchars($area):'' ?>"/>
                  ...
                  <input type="hidden" name="sec" value="<?= isset($_SESSION['Tipo'])?htmlspecialchars($_SESSION['Tipo']):'' ?>"/>
          </form>
...
<h2>Actualizar Persona</h2>
  <form  method="post" action="ActualizarPersonaSA.php">
    <br>
    <div class="form-group">
      <div class="col-md-12">
...
<h2>Ingresar Producto</h2>
  ...
  <!--Se pide al ADMIN  ingresar el codigo del producto para remover de la base de datos-->
      <form  method="post" action="RemoverProductoSA.php">
        <div class="form-group">
        <div class="col-md-6">
        <label class="control-label" for="code">Codigo del producto</label>
