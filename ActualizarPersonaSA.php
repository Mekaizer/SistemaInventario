...
if(isset($_POST["enviar"])){
    ...
    if($cont!=0){
      if($cont==2){
        echo "<script> alert('Se han actualizado los datos');location.assign('ingresoSuperAdmin.php')</script>";
      }else{
        echo "<script> alert('Se ha actualizado el datos');location.assign('ingresoSuperAdmin.php')</script>";
      }
    }else{
      echo "<script> alert('No se han realizado cambios');location.assign('ingresoSuperAdmin.php')</script>";
    }
...
<center><input class="form-control" id="myInput" type="text"  style="width: 450px" placeholder="Escriba aqui Rut, nombre, rol o Area del usuario a buscar">
